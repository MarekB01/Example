...
import com.example.Employee_DB.EmployeeDbApplication;
import com.example.Employee_DB.model.Employee;

@RunWith(SpringRunner.class)
@SpringBootTest(classes = EmployeeDbApplication.class, webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
